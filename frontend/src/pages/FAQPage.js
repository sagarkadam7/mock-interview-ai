  ...
  return (
    <div className="min-h-screen">
      <div className="page-shell max-w-5xl pb-8 pt-6">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 no-underline hover:text-aura-ink dark:text-slate-400 dark:hover:text-slate-100"
        >
          ← Back to home
        </Link>
      </div>
