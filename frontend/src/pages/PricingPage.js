...
const pricingFaq = [
  {
    q: "Is Pro refundable?",
    a: "If Pro isn’t helping you practice more effectively, we’ll make it right. Reach out and we’ll help you troubleshoot or refund.",
  },
  {
    q: "Can I cancel anytime?",
    a: "Yes. Pro is month-to-month. Cancel anytime and keep access until the end of the billing period.",
  },
  {
    q: "Do I need Pro to try the product?",
    a: "No. Starter is free and includes the core interview flow so you can see your scorecard before upgrading.",
  },
];
    ...
    <div className="min-h-screen">
      <div className="page-shell max-w-5xl pb-20">
        <div className="mb-14 border-b border-slate-200/80 pb-10 dark:border-slate-800/80">
          ...
          <h1 className="font-display text-4xl font-semibold tracking-tight text-aura-ink md:text-5xl">
            Simple today. Ambitious tomorrow.
          </h1>
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-slate-600 dark:text-slate-400">
            Start free, then upgrade when you want unlimited sessions and shareable reports for mentors and
            referrals.
          </p>
        ...
        <div className="mb-10 flex flex-col items-start justify-between gap-4 rounded-2xl border border-slate-200/80 bg-white/70 px-6 py-5 shadow-sm dark:border-slate-700/70 dark:bg-slate-900/45 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1 text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              Annual saves ~25%. Switch anytime.
            </p>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <div
              className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-gradient-to-br from-violet-200/40 to-transparent blur-3xl dark:from-violet-900/35 dark:to-transparent"
              aria-hidden
            />
            ...
            <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
              Everything you need to run serious reps — no credit card.
            </p>
            ...
            {!user ? (
              ...
              <div className="mt-10 rounded-2xl border border-slate-200 bg-white/80 px-5 py-4 text-sm text-slate-600 dark:border-slate-700/80 dark:bg-slate-900/60 dark:text-slate-300">
                You’re currently on{" "}
                <strong className="font-semibold text-aura-ink">{plan.toUpperCase()}</strong>.
              </div>
            )}
          </motion.div>
          ...
          >
            <div
              className="pointer-events-none absolute -left-24 -bottom-24 h-56 w-56 rounded-full bg-gradient-to-tr from-orange-200/35 to-transparent blur-3xl dark:from-orange-950/40 dark:to-transparent"
              aria-hidden
            />
            <p className="font-mono text-[10px] font-bold uppercase tracking-[0.28em] text-aura-coral dark:text-aura-coral">
              Pro
            </p>
            <div className="mt-2 flex items-baseline gap-2">
            ...
            <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
              Unlimited practice + shareable signal. Built for serious prep loops.
            </p>
            <ul className="mt-8 space-y-3">
              {pro.map((x, i) => (
                <li
        ...
        <div className="mt-10 rounded-3xl border border-emerald-200/70 bg-emerald-50/70 p-6 text-sm text-emerald-950 shadow-sm dark:border-emerald-500/25 dark:bg-emerald-950/40 dark:text-emerald-50 md:p-8">
          ...
          <p className="mt-2 leading-relaxed text-emerald-900/80 dark:text-emerald-100/80">
            If you don’t feel more confident and structured after consistent reps, we’ll help you fix your
            workflow or refund Pro.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 bg-white/90 p-6 text-sm leading-relaxed text-slate-600 shadow-sm dark:border-slate-700/80 dark:bg-slate-900/55 dark:text-slate-300 md:p-8">
            <strong className="font-semibold text-aura-ink">Fair use:</strong> automated systems may
            rate-limit abusive traffic to keep latency low for everyone. Personal practice within normal
            bounds is always the goal.
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white/90 p-6 text-sm leading-relaxed text-slate-600 shadow-sm dark:border-slate-700/80 dark:bg-slate-900/55 dark:text-slate-300 md:p-8">
        ...
        <div className="mt-12">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {pricingFaq.map((x) => (
              <div
                key={x.q}
                className="rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-sm dark:border-slate-700/70 dark:bg-slate-900/55"
              >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200/80 bg-white/70 px-6 py-5 text-sm text-slate-600 shadow-sm dark:border-slate-700/70 dark:bg-slate-900/45 dark:text-slate-300">
          <span>
            ...
            <span className="font-semibold text-aura-ink dark:text-slate-100">Run one session</span> and
            decide after you see your scorecard.
          </span>
