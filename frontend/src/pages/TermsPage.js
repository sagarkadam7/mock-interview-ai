      ...
      <div className="page-shell max-w-3xl pb-16 pt-4">
        ...
        <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
          <section>
            ...
            <p className="mt-3">
              By creating an account or using InterviewAI, you agree to these terms. If you deploy your own
              instance, your organization may publish supplemental policies.
            </p>
          </section>
          <section>
            <h2 className="text-lg font-bold text-aura-ink">The service</h2>
            <p className="mt-3">
              InterviewAI provides practice tools and AI-generated feedback. It does not guarantee job offers
              or interview outcomes. Coaching metrics (e.g. eye contact estimates) are heuristic and not
          ...
          <section>
            ...
            <p className="mt-3">
              Do not abuse APIs, attempt to access other users’ data, or upload unlawful content. We may
              rate-limit or suspend accounts that degrade service for others.
            </p>
          </section>
          <section>
            <h2 className="text-lg font-bold text-aura-ink">Third parties</h2>
            <p className="mt-3">
              The product relies on infrastructure and AI vendors (hosting, database, model APIs). Their terms
              may apply to subprocessors they use.
            </p>
          </section>
          <section>
            ...
            <p className="mt-3">
              ...
              by law, we are not liable for indirect or consequential damages arising from use of the product.
            </p>
          </section>
        </div>
      </div>
