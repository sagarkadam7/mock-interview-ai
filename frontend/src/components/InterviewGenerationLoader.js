...
export default function InterviewGenerationLoader({ active, className = "" }) {
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-2xl border border-violet-200/70 bg-gradient-to-br from-white via-violet-50/40 to-orange-50/30 p-6 shadow-lg shadow-violet-500/10 ring-1 ring-white/80 dark:border-violet-500/25 dark:from-slate-900/95 dark:via-violet-950/30 dark:to-slate-950 dark:shadow-violet-900/20 dark:ring-slate-800/60 sm:p-8 ${className}`}
    >
      <div
      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:gap-8">
        ...
        <div className="min-w-0 flex-1 text-center sm:text-left">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h3 className="mt-2 font-display text-xl font-semibold tracking-tight text-aura-ink dark:text-slate-100">
