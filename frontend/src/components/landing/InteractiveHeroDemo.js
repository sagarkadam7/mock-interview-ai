...
const SAMPLE_TRANSCRIPT =
  "Well, um, I think my biggest weakness is, like, I sometimes take on too much work.";
      ...
      >
        <div className="relative overflow-hidden rounded-[1.3rem] border border-slate-200/75 bg-gradient-to-br from-white/98 to-slate-50/92 p-6 backdrop-blur-xl dark:border-slate-700/65 dark:from-slate-900/95 dark:to-slate-950/92 sm:p-8">
          ...
          <div className="relative">
            <div className="flex items-center justify-between gap-3">
              <div className="flex min-w-0 items-center gap-2">
                <span
                  className="inline-flex h-2 w-2 shrink-0 rounded-full bg-emerald-500 shadow-[0_0_0_4px_rgba(16,185,129,0.2)]"
                  aria-hidden
                />
          ...
          <div className="relative mt-8 flex flex-col items-center">
            <div className="relative grid place-items-center">
              ...
              >
                {phase === "recording" && (
                  <span
                    aria-hidden
                    className="absolute inset-[-6px] animate-ping rounded-full bg-rose-500/20"
                  />
                )}
                <span
                  aria-hidden
            ...
            <p
              className="mt-5 max-w-[260px] text-center text-[13px] font-medium leading-snug text-slate-600 dark:text-slate-400 sm:max-w-[320px]"
              aria-live="polite"
            >
          ...
          <div className="relative mt-7 rounded-2xl border border-slate-200/85 bg-white/85 p-4 shadow-[0_12px_40px_-28px_rgba(15,23,42,0.2)] dark:border-slate-700/80 dark:bg-slate-900/75 sm:p-5">
            ...
            <p className="mt-3 min-h-[5.25rem] text-[15px] leading-relaxed text-slate-800 dark:text-slate-100 sm:min-h-[5.5rem]">
              ...
              {phase === "transcribing" && (
                <span
                  aria-hidden
                  className="ml-0.5 inline-block h-[1.1em] w-[2px] -translate-y-[2px] animate-pulse bg-aura-violet align-middle"
                />
              )}
            </p>
          </div>
