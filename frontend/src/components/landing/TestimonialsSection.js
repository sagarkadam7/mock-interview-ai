    ...
    <section className="relative py-24 md:py-28">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-[15px] text-slate-600">Early users from campus and internship loops — anonymized quotes.</p>
        </div>
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <figcaption className="mt-8 border-t border-slate-100 pt-6">
                ...
                <div className="mt-1 text-xs font-medium uppercase tracking-wider text-slate-500">{t.role}</div>
              </figcaption>
            </motion.figure>
          ))}
        </div>
