...
export default function PricingTeaserSection() {
  return (
    <section className="border-y border-slate-200/80 bg-gradient-to-b from-slate-50/80 to-white py-24 md:py-28">
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-[15px] text-slate-600">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-slate-200/90 bg-white p-8 shadow-lux-lg ring-1 ring-white/80 md:p-12"
        >
          ...
          <div className="relative grid gap-10 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="mt-3 max-w-md text-sm text-slate-600">Full core product — interviews, AI feedback, reports, and dashboard history.</p>
